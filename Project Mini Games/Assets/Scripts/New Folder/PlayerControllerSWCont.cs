...
//public class PlayerControllerSWCont : MonoBehaviour
//{
...
//            Vector3 newForward = Vector3.RotateTowards(playerTransform.forward, playerDirection, rotationSpeed * Time.deltaTime, 0f);
